...
export function Component({
  ...
  const hueAnimation = useRef<AnimationPlaybackControls | null>(null);
  ...
  useEffect(() => {
    ...
    hueAnimation.current?.stop();
    hueRotate.set(0);
    hueAnimation.current = animate(hueRotate, 360, {
    ...
    return () => hueAnimation.current?.stop();
